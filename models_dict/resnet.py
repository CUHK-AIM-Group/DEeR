...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=200):
        ...
        self.linear_proto_meilu = nn.Linear(512*block.expansion, 512)
        self.classifier_meilu = None
        self.scaling_train_meilu = torch.nn.Parameter(torch.tensor(1.0))
...
class ResNet_cifar(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.linear_proto_meilu = nn.Linear(64*block.expansion, 512)
        self.classifier_meilu = None
        self.scaling_train_meilu = torch.nn.Parameter(torch.tensor(1.0))
